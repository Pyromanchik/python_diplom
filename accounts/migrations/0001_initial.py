    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('client', 'client'), ('supplier', 'supplier'), ('admin', 'admin')], default='client', max_length=10, verbose_name='Роль')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('address_building', models.CharField(blank=True, max_length=50, verbose_name='Корпус')),
                ('address_structure', models.CharField(blank=True, max_length=50, verbose_name='Строение')),
                ('address_apartment', models.CharField(blank=True, max_length=50, verbose_name='Квартира')),
